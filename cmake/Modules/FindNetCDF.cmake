...
if(NETCDF_NC4)
  ...
  if(NETCDF_F90)
    NetCDF_check_feature("f90")
    if(NOT NETCDF_HAS_f90)
      message(STATUS "NetCDF not compiled with f90 support")
    else()
      NetCDF_get_flags("includedir" INCLUDES_F90)
      NetCDF_get_flags("flibs" LIBRARIES_F90)
      if (NOT NETCDF_LIBRARIES_F90)
        set(NETCDF_HAS_f90 "NO")
      elseif (NOT NETCDF_INCLUDES_F90)
        set(NETCDF_HAS_f90 "NO")
      else()
  ...
  if(NETCDF_F03)
    NetCDF_check_feature("f03")
    if(NOT NETCDF_HAS_f03)
      message(STATUS "NetCDF not compiled with f03 support")
    else()
      NetCDF_get_flags("includedir" INCLUDES_F03)
      NetCDF_get_flags("flibs" LIBRARIES_F03)
      if (NOT NETCDF_LIBRARIES_F03)
        set(NETCDF_HAS_f03 "NO")
      elseif (NOT NETCDF_INCLUDES_F03)
        set(NETCDF_HAS_f03 "NO")
      else()
